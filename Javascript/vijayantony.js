...
async function handlePayment() {
    ...
    const concertName = 'Vijay Antony Live in Concert';
    ...
    const options = {
        ...
        name: 'VijayAntony Live in Concert',
        description: 'Tickets',
        handler: async function (response) {
            ...
            const verifyResponse = await fetch(`/verify-payment/${userId}`, {
                ...
                body: JSON.stringify({
                    ...
                    currency: orderData.currency,
                    status: 'paid',
                    concertName: 'vijayantony concert'
                })
            });
            ...
            if (verifyData.success) {
                ...
                window.location.href = `/payment_status.html?paymentId=${response.razorpay_payment_id}&orderId=${orderData.id}&amount=${orderData.amount / 100}&currency=${orderData.currency}&status=paid&concertName=vijayantony concert`;
            } else {
